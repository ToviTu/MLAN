...
# Fine-tuning data
wget -O playground/data/MLAN_80k.json https://huggingface.co/datasets/ToviTu/MLAN/resolve/main/MLAN_80k.json
wget -O playground/data/MLAN_v_88l_80k.json https://huggingface.co/datasets/ToviTu/MLAN/resolve/main/MLAN_v_88l_80k.json
wget -O playground/data/MLAN_v_50l_80k.json https://huggingface.co/datasets/ToviTu/MLAN/resolve/main/MLAN_v_50l_80k.json

wget -O playground/data/images_mlan_v.zip https://huggingface.co/datasets/ToviTu/MLAN/resolve/main/images_mlan_v.zip
